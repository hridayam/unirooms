...
class ProfileFormCustomButton extends Component {
  ...
  render() {
    ...
    return (
      <Button
        title={title}
        textStyle={selected === false ? { fontFamily: 'titleFont', fontSize: this.props.fontSize, color: 'black', textAlign: 'center' } : { fontFamily: 'titleFont', fontSize: this.props.fontSize, color: 'white', textAlign: 'center' }}
